...
interface BuiltinReconcileContext<K extends BuiltinResourceKind> {
...
当前唯一 Output 是 `proposedInput`，Manager 将它持久化成 Proposal。未来若增加
...
6. 接通 Board projection、`proposedInput` 与可选 Context projection，跑通用户审核文本后驱动
