...
/** bs=BatonSession ps=ProviderSession t=Turn m=Message tc=ToolCall pl=Plan ar=ApprovalRequest qr=QuestionRequest */
export type IdPrefix = "bs" | "ps" | "t" | "m" | "tc" | "pl" | "ar" | "qr";
